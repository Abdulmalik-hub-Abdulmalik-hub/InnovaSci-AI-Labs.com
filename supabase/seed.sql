...
-- Insert Users (password: innovasci123 - hashed with bcrypt)
...
('blog_001', 'The Future of AI in Scientific Research', 'future-ai-scientific-research', 'AI is revolutionizing how we conduct scientific research. From drug discovery to climate modeling, artificial intelligence is accelerating discoveries that would take decades using traditional methods. At InnovaSci AI Labs, we are pioneering new approaches to integrate AI into every stage of the research pipeline.', 'Explore how artificial intelligence is transforming scientific discovery and research methodologies.', 'usr_004', 'Dr. Layla Rahman', 'AI,Research,Science', 'Research', true, NOW()),
('blog_002', 'Building Scalable ML Pipelines', 'scalable-ml-pipelines', 'Learn the best practices for building production-ready ML pipelines. This comprehensive guide covers everything from data preprocessing to model deployment, including MLOps best practices, monitoring strategies, and optimization techniques.', 'A comprehensive guide to designing and implementing scalable machine learning infrastructure.', 'usr_013', 'Dr. Amir Patel', 'ML,Engineering,Tutorial', 'Engineering', true, NOW()),
('blog_003', 'EdTech Trends 2026', 'edtech-trends-2026', 'The landscape of educational technology is evolving rapidly. From AI-powered personalization to immersive VR learning experiences, discover the top EdTech trends shaping the future of learning in 2026 and beyond.', 'Discover the top EdTech trends shaping the future of learning in 2026.', 'usr_005', 'Youssef Mansour', 'EdTech,Education,Trends', 'Education', true, NOW()),
('blog_004', 'Quantum Computing Meets AI', 'quantum-computing-ai', 'The intersection of quantum computing and artificial intelligence represents the next frontier in computational science. Explore the potential of quantum-enhanced AI systems and how they will revolutionize problem-solving across industries.', 'Exploring the potential of quantum-enhanced AI systems.', 'usr_004', 'Dr. Layla Rahman', 'Quantum,AI,Innovation', 'Research', true, NOW())
ON CONFLICT (id) DO NOTHING;

-- Insert Forum Threads
INSERT INTO forum_threads (id, title, content, slug, author_id, author_name, category, tags, views, replies, is_pinned, is_locked) VALUES
('thread_001', 'Welcome to InnovaSci Forum', 'Welcome everyone! This is a space for researchers, developers, and AI enthusiasts to connect and collaborate. Feel free to share your projects, ask questions, and engage with our community.', 'welcome-forum', 'usr_001', 'Ahmad Al-Farsi', 'General', 'welcome,announcements', 245, 12, true, false),
('thread_002', 'Best Practices for Model Deployment', 'What are your recommended strategies for deploying ML models at scale? I am looking for insights on orchestration, monitoring, and optimization techniques for production environments.', 'model-deployment-best-practices', 'usr_013', 'Dr. Amir Patel', 'AI/ML', 'machine-learning,deployment,mlops', 189, 8, false, false),
('thread_003', 'EdTech Integration Tips', 'Sharing some tips for integrating our Learn Platform with existing systems. Happy to answer questions about API integration, SSO setup, and custom configurations.', 'edtech-integration-tips', 'usr_016', 'Aisha Mohammed', 'EdTech', 'edtech,integration,lms', 156, 6, false, false)
ON CONFLICT (id) DO NOTHING;

-- Insert Forum Replies
INSERT INTO forum_replies (id, thread_id, content, author_id, author_name) VALUES
('reply_001', 'thread_002', 'Great topic! I recommend using Kubernetes for orchestration and implementing proper monitoring with Prometheus and Grafana. Also consider using model versioning with DVC.', 'usr_007', 'James Chen'),
('reply_002', 'thread_002', 'Also consider using model caching and implementing A/B testing for gradual rollouts. We have had great success with feature flags for this.', 'usr_014', 'Wei Zhang'),
('reply_003', 'thread_001', 'Excited to be part of this community! Looking forward to great discussions and collaborations.', 'usr_022', 'Dr. Emma Thompson')
ON CONFLICT (id) DO NOTHING;
...
('msg_002', 'sess_001', 'assistant', 'Welcome to InnovaSci AI Core! To get started, follow these steps:\n\n1. Navigate to the Products section\n2. Select AI Core\n3. Click "Start Free Trial"\n4. Follow the onboarding wizard\n\nYou will have access to model training, deployment tools, and our GPU cluster.')
ON CONFLICT (id) DO NOTHING;
